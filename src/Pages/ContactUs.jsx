...
const ContactUs = () => {
  return (
    <div className="flex flex-col mt-[9rem] gap-20">
      <h1 className="font-Alegreya text-[10rem] text-center text-lime-600 leading-none tracking-tight">
        Get in Touch!
      </h1>
      <div className="flex justify-center mb-20 lap:gap-20">
            ...
            <div className="flex gap-8">
              <div className="flex flex-col gap-1">
                ...
                <input
                  ...
                  id="Phone"
                  className="border border-black rounded-md w-60 h-8 text-lg font-Kanit px-3 
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex gap-4 justify-center">
              ...
              <div className="flex items-center gap-2 font-Lato">
                <MdEmail />
                <a
                  href="mailto:surabhitrust@gmail.com"
                  target="_blank"
            ...
            <iframe
              className="rounded-xl border border-lime-600 mt-4"
