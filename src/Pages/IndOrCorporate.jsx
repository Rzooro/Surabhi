...
const IndOrCorporate = () => {
  return (
    <div className="mt-[9rem] flex flex-col items-center gap-24">
      <div className="flex flex-col items-center gap-10">
        <h1 className="text-[7rem] leading-none font-Oswald tracking-tight text-lime-600">
          INDIVIDUALS
        </h1>
        <div className="flex gap-x-6 gap-y-4 flex-col items-center">
          <div className="flex gap-x-6">
            <div className="flex flex-col rounded-2xl border-2 border-black px-4 py-3 items-center gap-2">
              <h1 className="font-Oswald text-4xl">Donate</h1>
          ...
          <div className="flex gap-x-6">
            <div className="flex flex-col rounded-2xl border-2 border-black px-4 py-3 items-center gap-2">
              <h1 className="font-Oswald text-4xl">Attend an Event</h1>
              <p className="font-Lato text-lg text-center">
            ...
            <div className="flex flex-col rounded-2xl border-2 border-black px-4 py-3 items-center gap-2">
              <h1 className="font-Oswald text-4xl">Celebrate With Us</h1>
              <p className="font-Lato text-lg text-center">
                Create memories with our children and share your joy!
                <br />
            ...
            <div className="flex flex-col rounded-2xl border-2 border-black px-4 py-3 items-center gap-2">
              <h1 className="font-Oswald text-4xl">In-Tribute Donations</h1>
              <p className="font-Lato text-lg text-center">
      ...
      <div className="flex flex-col items-center gap-10 pb-10">
        ...
        <div className="flex gap-x-6 gap-y-4 flex-col items-center">
          <div className="flex gap-x-6">
            <div className="flex flex-col rounded-2xl border-2 border-black px-4 py-3 items-center gap-2">
              <h1 className="font-Oswald text-4xl">Corporate Giving</h1>
              <p className="font-Lato text-lg text-center">
            ...
            <div className="flex flex-col rounded-2xl border-2 border-black px-4 py-3 items-center gap-2">
              <h1 className="font-Oswald text-4xl">Become an Investor</h1>
              <p className="font-Lato text-lg text-center">
                {" "}
          ...
          <div className="flex gap-x-6">
            <div className="flex flex-col rounded-2xl border-2 border-black px-4 py-3 items-center gap-2">
              <h1 className="font-Oswald text-4xl">Sponsor an Event</h1>
              <p className="font-Lato text-lg text-center">
            ...
            <div className="flex flex-col rounded-2xl border-2 border-black px-4 py-3 items-center gap-2">
              <h1 className="font-Oswald text-4xl">Corporate Volunteering</h1>
              <p className="font-Lato text-lg text-center">
            ...
            <div className="flex flex-col rounded-2xl border-2 border-black px-4 py-3 items-center gap-2">
              <h1 className="font-Oswald text-4xl">In-Kind Contributions</h1>
              <p className="font-Lato text-lg text-center">
