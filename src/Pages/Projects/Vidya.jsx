    ...
    <>
      <div
        ...
        <div
          ...
          <h1 className="text-6xl lap:text-8xl whitespace-nowrap text-rose-600 font-Fira_Sans_Condensed font-bold">
            Vidya Surabhi
          </h1>
          <div className="h-0.5 bg-rose-600 w-2/3"></div>
        </div>
      ...
      <div className="flex flex-col gap-2 items-center py-5">
        <h1 className="font-bold font-Oswald tracking-tight text-rose-600 text-4xl lap:text-6xl pb-2 w-[95%] lap:w-fit lap:-translate-x-[15rem]">
          EMPOWERING YOUNG MINDS
        </h1>
        <p className="font-Lato tracking-tight w-[95%] lap:w-[60rem] font-bold lap:text-2xl">
      ...
      <div className="flex flex-col items-center gap-5 py-10">
        <div className="flex flex-col w-[95%] lap:w-[50rem] bg-teal-500 rounded-xl p-6 sticky top-32 gap-2">
          <h1 className="text-2xl lap:text-4xl text-rose-600 lap:w-[30rem] font-Oswald font-bold">
            PROVIDING RESOURCES FOR THEIR JOURNEY
          </h1>
          <p className="lap:w-[45rem] font-Lato lap:text-xl">
        ...
        <div className="flex flex-col w-[95%] lap:w-[50rem] bg-teal-400 rounded-xl p-6 sticky top-48 gap-2">
          <h1 className="text-2xl lap:text-4xl text-rose-600 font-Oswald font-bold">
      ...
      <div className="flex flex-col items-center py-8 bg-teal-500">
        ...
        <div className="flex flex-col items-center lap:gap-5">
          <div className="flex flex-col lap:flex-row lap:items-baseline">
            <div className="flex flex-col gap-2 items-center border-b-[0.05rem] border-r-[0.05rem] border-gray-300 pb-3 lap:pr-5 lap:pb-8">
              <h1 className="text-2xl text-rose-600 font-Archivo font-extralight">
                Increased Enrolment
              </h1>
              <p className="font-Lato w-[95%] lap:w-[30rem] text-center">
            ...
            <div className="flex flex-col gap-2 items-center border-b-[0.05rem] border-gray-300 pb-3 lap:pl-5 lap:pb-8">
              <h1 className="text-2xl text-rose-600 font-Archivo font-extralight">
                Empowered Students
              </h1>
              <p className="font-Lato w-[95%] lap:w-[30rem] text-center">
      ...
      <div className="flex flex-col items-center gap-5 py-14">
        ...
        <Link to="/donate">
          <button
            className="bg-rose-600 rounded-xl font-Outfit lap:text-lg px-2 py-1 transition-transform
