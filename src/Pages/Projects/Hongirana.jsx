    ...
    <>
      <div
        ...
        <div
          ...
          <h1 className="text-8xl whitespace-nowrap text-yellow-500 font-Fira_Sans_Condensed font-bold">
            Surabhi Hongirana
          </h1>
          <div className="h-0.5 bg-yellow-500 w-2/3"></div>
        </div>
      ...
      <div className="flex flex-col gap-5 py-2 items-center">
        <h1 className="font-bold font-Oswald tracking-tight text-yellow-500 text-6xl -translate-x-[25rem]">
          OUR DREAM
        </h1>
      ...
      <div className="flex flex-col items-center gap-5 my-10">
        <div className="flex flex-col w-[55rem] bg-fuchsia-800 rounded-xl p-6 sticky top-32 gap-2">
          <h1 className="text-4xl text-yellow-500 font-Oswald font-bold">
        ...
        <div className="flex flex-col w-[55rem] bg-fuchsia-700 rounded-xl p-6 sticky top-48 gap-2">
          <h1 className="text-4xl text-yellow-500 font-Oswald font-bold">
        ...
        <div className="flex flex-col w-[55rem] bg-fuchsia-600 rounded-xl p-6 sticky top-[18.5rem] gap-2">
          <h1 className="text-4xl text-yellow-500 font-Oswald font-bold">
            HEALTH AND HYGIENE
          </h1>
          <p className="w-[45rem] font-Lato text-xl">
        ...
        <div className="flex flex-col w-[55rem] bg-fuchsia-500 rounded-xl p-6 sticky top-[30rem] gap-2">
          <h1 className="text-4xl text-yellow-400 font-Oswald font-bold">
            SCALE AND IMPACT
          </h1>
          <p className="w-[45rem] font-Lato text-xl">
      ...
      <div className="flex flex-col bg-gray-200 items-center gap-5 py-10">
        <h1 className="font-bold font-Oswald tracking-tight text-yellow-500 text-6xl flex gap-3 items-center">
          SURABHI SEVADHAMA:{" "}
          <span className="font-Dancing_Script text-fuchsia-600">
            A Home away from home
          </span>
        </h1>
        <p className="w-[52rem] font-Lato text-lg">
        ...
        <div className="flex flex-col items-center gap-8">
          <h1 className="font-bold font-Oswald text-yellow-500 mt-10 text-5xl flex items-center">
            THINGS YOU
            <span className="text-fuchsia-600">'</span>LL LOVE ABOUT US
            <span className="text-fuchsia-600">!</span>
          </h1>
          <div className="flex flex-col">
            <div className="flex lap:gap-14">
              <div className="flex justify-center gap-2">
                <div className="px-4 py-4 bg-yellow-500 rounded-3xl h-fit">
                  <FaShieldHeart className="size-10" />
                </div>
                <div className="mt-2">
              ...
              <div className="flex justify-center gap-2">
                <div className="px-4 py-4 bg-yellow-500 rounded-3xl h-fit">
                  <FaPuzzlePiece className="size-10 translate-x-1" />
                </div>
                <div className="mt-2">
                  <h1 className="font-Inter font-bold text-lg">
            ...
            <div className="flex lap:gap-14">
              ...
              <div className="flex justify-center gap-2">
                <div className="px-4 py-4 bg-yellow-500 rounded-3xl h-fit">
                  <FaBasketballBall className="size-10" />
                </div>
                <div className="mt-2">
                  <h1 className="font-Inter font-bold text-lg">
      ...
      <div className="flex flex-col items-center py-10 gap-8">
        <p className="font-Lato font-bold text-lg w-[58rem]">
        ...
        <Link to="/donate">
          <button
            className="bg-yellow-500 rounded-xl font-Outfit text-lg px-2 py-1 transition-transform
