    ...
    <>
      <div
        ...
        <div
          ...
          <h1 className="text-6xl lap:text-8xl whitespace-nowrap text-lime-700 font-Fira_Sans_Condensed font-bold">
            Surabhi Hasiru
          </h1>
          <div className="h-0.5 bg-lime-700 w-2/3"></div>
        </div>
      ...
      <div className="flex flex-col gap-5 py-5 items-center">
        <h1 className="font-bold font-Oswald tracking-tight text-lime-700 text-4xl lap:text-6xl lap:-translate-x-[16rem]">
          NURTURING NATURE'S LEGACY
        </h1>
        <p className="font-Lato tracking-tight w-[95%] lap:w-[60rem] font-bold text-lg lap:text-2xl">
      ...
      <div className="flex flex-col items-center gap-5 py-10">
        <div className="flex flex-col w-[95%] lap:w-[50rem] bg-orange-600 rounded-xl p-6 sticky top-32 gap-4">
          <h1 className="text-3xl lap:text-4xl text-lime-700 font-Oswald font-bold">
        ...
        <div className="flex flex-col w-[95%] lap:w-[50rem] bg-orange-500 rounded-xl p-6 sticky top-48 gap-2">
          <h1 className="text-3xl lap:text-4xl text-lime-700 font-Oswald font-bold">
      ...
      <div className="flex flex-col bg-gray-200 items-center gap-3 py-5">
        <h1 className="text-4xl lap:text-6xl text-lime-700 font-Oswald font-bold">
          OUR VISION
        </h1>
        <p className="font-Lato tracking-tight w-[95%] lap:w-[60rem] font-bold text-lg lap:text-xl">
      ...
      <div className="flex flex-col items-center py-8 gap-5">
        <h1 className="text-5xl lap:text-6xl text-lime-700 font-Fira_Sans_Condensed font-bold">
        ...
        <div className="flex tab:flex-row flex-col items-center gap-3">
          <Link to="/Volunteer-or-Intern">
            ...
            lap:hover:ring-orange-500 transition-all duration-300 w-60">
              <h1 className="text-3xl lap:text-4xl text-lime-700 font-Fresca font-bold tracking-tight">
                Volunteer
              </h1>
          ...
          <Link to="/Contact-us">
            ...
            lap:hover:ring-orange-500 transition-all duration-300 w-72">
              <h1 className="text-3xl lap:text-4xl text-lime-700 whitespace-nowrap font-Fresca font-bold tracking-tight">
                Spread Awareness
              </h1>
      ...
      <div className="flex justify-center py-5">
        <p className="font-Lato w-[95%] lap:w-auto font-bold lap:text-2xl">
