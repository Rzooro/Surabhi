    ...
    <>
      <div
        ...
        <div
          ...
          <h1 className="text-8xl whitespace-nowrap text-green-500 font-Fira_Sans_Condensed font-bold">
            Surabhi Arogya
          </h1>
          <div className="h-0.5 bg-green-500 w-2/3"></div>
        </div>
      ...
      <div className="flex flex-col gap-5 py-2 items-center">
        <h1 className="font-bold font-Oswald tracking-tight text-green-500 text-6xl -translate-x-[22rem]">
      ...
      <div className="flex flex-col items-center gap-5 my-10">
        <div className="flex flex-col w-[55rem] bg-red-800 rounded-xl p-6 sticky top-32 gap-2">
          <h1 className="text-4xl text-green-500 font-Oswald font-bold">
            EXTENSIVE REACH
          </h1>
        ...
        <div className="flex flex-col w-[55rem] bg-red-700 rounded-xl p-6 sticky top-48 gap-2">
          <h1 className="text-4xl text-green-500 font-Oswald font-bold">
        ...
        <div className="flex flex-col w-[55rem] bg-red-600 rounded-xl p-6 sticky top-[16rem] gap-2">
          <h1 className="text-4xl text-green-500 font-Oswald font-bold">
            SUPPORTING STUDENTS
          </h1>
          <p className="w-[45rem] font-Lato text-xl">
        ...
        <div className="flex flex-col w-[55rem] bg-red-500 rounded-xl p-6 sticky top-[20rem] gap-2">
          <h1 className="text-4xl text-green-500 font-Oswald font-bold">
            DISASTER RELIEF
          </h1>
          <p className="w-[45rem] font-Lato text-xl">
      ...
      <div className="flex flex-col items-center py-8 gap-10">
        <div className="flex flex-col items-center gap-5">
          <h1 className="text-6xl text-green-500 font-Fira_Sans_Condensed font-bold">
            OUR APPROACH
          </h1>
          <p className="font-Lato tracking-tight w-[58rem] font-bold text-2xl text-center">
        ...
        <div className="flex flex-col items-center gap-5">
          ...
          <p className="font-Lato tracking-tight w-[55rem] font-bold text-2xl text-center">
