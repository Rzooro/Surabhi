    ...
    <>
      <div
        ...
        <div
          ...
          <h1 className="text-6xl lap:text-8xl whitespace-nowrap text-sky-800 font-Fira_Sans_Condensed font-bold">
            Surabhi Ashraya
          </h1>
          <div className="h-0.5 bg-sky-800 w-2/3"></div>
        </div>
      ...
      <div className="flex flex-col gap-5 py-2 items-center">
        <h1 className="font-bold font-Oswald tracking-tight text-sky-800 text-4xl lap:text-6xl lap:-translate-x-[22rem]">
          EMPOWERING LIVES
        </h1>
      ...
      <div className="flex flex-col items-center gap-5 my-10">
        <div className="flex flex-col lap:w-[55rem] bg-green-700 rounded-xl p-6 sticky top-32 gap-2">
          <h1 className="text-3xl lap:text-4xl text-sky-800 font-Oswald font-bold">
            QUALITY SHELTER
          </h1>
          <p className="lap:w-[45rem] font-Lato lap:text-lg">
        ...
        <div className="flex flex-col lap:w-[55rem] bg-green-600 rounded-xl p-6 sticky top-48 gap-2">
          <h1 className="text-3xl lap:text-4xl text-sky-800 font-Oswald font-bold">
        ...
        <div className="flex flex-col lap:w-[55rem] bg-green-500 rounded-xl p-6 sticky top-[16rem] gap-2">
          <h1 className="text-3xl lap:text-4xl text-sky-800 font-Oswald font-bold">
        ...
        <div className="flex flex-col lap:w-[55rem] bg-green-400 rounded-xl p-6 sticky top-[20rem] gap-2">
          <h1 className="text-3xl lap:text-4xl text-sky-800 font-Oswald font-bold">
        ...
        <div className="flex flex-col lap:w-[55rem] bg-green-300 rounded-xl p-6 sticky top-[30rem] gap-2">
          <h1 className="text-3xl lap:text-4xl text-sky-800 font-Oswald font-bold">
      ...
      <div className="flex flex-col items-center py-8 gap-10">
        <div className="flex flex-col items-center gap-5">
          <h1 className="text-4xl lap:text-6xl text-sky-800 font-Fira_Sans_Condensed font-bold">
            IMPACT
          </h1>
          <p className="font-Lato tracking-tight w-[95%] lap:w-[58rem] font-bold text-lg lap:text-2xl">
        ...
        <div className="flex flex-col items-center gap-5">
          ...
          <p className="font-Lato tracking-tight w-[95%] lap:w-[55rem] font-bold text-lg lap:text-2xl">
