  ...
  return (
    <div className="hidden lap:flex flex-col pt-10 pb-16 relative">
      ...
      <div
        ...
        <div className="flex lap:gap-[30rem] justify-center">
          <div
        ...
        <div className="flex lap:gap-[40rem] justify-center">
          <div
        ...
        <div className="flex lap:gap-[50rem] justify-center">
          <div
      ...
      <div className="flex absolute left-[50%] -translate-x-[252px] top-52 w-fit z-20">
      ...
      <img
        src={logo}
        alt="Logo"
        className="place-self-center -mt-[13rem] lap:size-44"
      />
    </div>
  );
};
